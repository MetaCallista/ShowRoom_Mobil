...
const DetailReservasiUserPage = () => {
  const navigate = useNavigate();
  return (
    <div className="p-6 bg-white rounded-xl shadow-md max-w-7xl mx-auto">
      <button onClick={() => navigate('/user/reservasi', { state: { tab: '2' } })} className="mb-4 flex items-center gap-2 text-blue-600 hover:underline">
...
export default DetailReservasiUserPage; 