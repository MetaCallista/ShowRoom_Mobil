...
const KelolaMobil = () => {
  ...
  const columns = [
    ...
    { title: 'Aksi', key: 'aksi', render: (_, record) => (<Space size="middle"><Button icon={<EditOutlined />} onClick={() => navigate(`/admin/mobil/edit/${record.id}`)}>Edit</Button><Popconfirm title="Yakin ingin menghapus mobil ini?" onConfirm={() => handleDelete(record)} okText="Ya, Hapus" cancelText="Batal"><Button icon={<DeleteOutlined />} danger /></Popconfirm></Space>), },
  ];
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-md">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button type="primary" icon={<PlusOutlined />} size="large" onClick={() => navigate('/admin/mobil/tambah')}>
          Tambah Mobil
        </Button>
      </div>
