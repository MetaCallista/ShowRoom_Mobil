...
const ExploreVehicles = () => {
  ...
  useEffect(() => {
    ...
    const placeholderCars = [
      { id: 1, name: 'Toyota Camry New', spec: '3.5 D5...', mileage: '20 Miles', fuel: 'Bensin', transmission: 'Otomatis', price: 40000, imageUrl: '/assets/images/camry.png', badge: 'Harga Terbaik' },
