      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mt-16 text-sm">
          <div className="space-y-4">
            ...
            <Link to="/" className="block hover:text-blue-600">Beranda</Link>
            <Link to="/listing" className="block hover:text-blue-600">Daftar Mobil</Link>
            <Link to="/blog" className="block hover:text-blue-600">Artikel</Link>
            <Link to="/bantuan" className="block hover:text-blue-600">Bantuan</Link>
            <Link to="/kontak" className="block hover:text-blue-600">Kontak Kami</Link>
          </div>
          <div className="space-y-4">
